...
metadata {
	definition(name: "Z-Wave Switch Secure", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.switch", runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: false, genericHandler: "Z-Wave") {
		...
		fingerprint mfr: "0086", prod: "0003", model: "008B", deviceJoinName: "Aeon Switch"
		fingerprint mfr: "0086", prod: "0103", model: "008B", deviceJoinName: "Aeon Switch"
		fingerprint mfr: "027A", prod: "A000", model: "A001", deviceJoinName: "Zooz Switch"
	}
