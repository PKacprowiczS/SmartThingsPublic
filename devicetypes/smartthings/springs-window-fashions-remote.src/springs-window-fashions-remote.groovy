...
metadata {
    definition (name: "Springs Window Fashions Remote", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "x.com.st.d.remotecontroller", hidden: true) {
        ...
        fingerprint mfr:"026E", prod:"5643", model:"5A31", deviceJoinName: "SpringsWindowFashions Window Treatment"
        fingerprint mfr:"026E", prod:"4252", model:"5A31", deviceJoinName: "SpringsWindowFashions Window Treatment"
    }
