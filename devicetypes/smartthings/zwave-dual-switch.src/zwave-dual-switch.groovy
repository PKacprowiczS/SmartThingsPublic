...
metadata {
	definition(name: "Z-Wave Dual Switch", namespace: "smartthings", author: "SmartThings", mnmn: "SmartThings", vid: "generic-switch") {
		...
		fingerprint mfr: "0086", prod: "0103", model: "008C", deviceJoinName: "Aeotec Switch"
		fingerprint mfr: "0086", prod: "0003", model: "008C", deviceJoinName: "Aeotec Switch"
		// sometimes the aeotec nano dual switch does not update its NIF when adding securely
		fingerprint mfr: "0000", cc: "0x5E,0x25,0x27,0x81,0x71,0x60,0x8E,0x2C,0x2B,0x70,0x86,0x72,0x73,0x85,0x59,0x98,0x7A,0x5A", ccOut: "0x82", ui: "0x8700", deviceJoinName: "Aeotec Switch"
		fingerprint mfr: "0258", prod: "0003", model: "008B", deviceJoinName: "NEOCoolcam Switch"
		fingerprint mfr: "0258", prod: "0003", model: "108B", deviceJoinName: "NEOCoolcam Switch"
		fingerprint mfr: "0312", prod: "C000", model: "C004", deviceJoinName: "EVALOGIK Outlet"
		fingerprint mfr: "0312", prod: "FF00", model: "FF05", deviceJoinName: "Minoston Outlet"
		fingerprint mfr: "0312", prod: "C000", model: "C007", deviceJoinName: "EVALOGIK Outlet"
	}
