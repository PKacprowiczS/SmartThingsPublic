...
metadata {
	definition(name: "Z-Wave Water Sensor", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "x.com.st.d.sensor.moisture", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
		...
		fingerprint mfr: "021F", prod: "0003", model: "0085", deviceJoinName: "Dome Water leak sensor"
		fingerprint mfr: "0258", prod: "0003", model: "1085", deviceJoinName: "NEOCoolcam Water leak sensor"
		fingerprint mfr: "0086", prod: "0102", model: "007A", deviceJoinName: "Aeotec Water leak sensor"
		fingerprint mfr: "0086", prod: "0002", model: "007A", deviceJoinName: "Aeotec Water leak sensor"
